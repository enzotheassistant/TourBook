      ...
      <div className="w-full max-w-md overflow-hidden rounded-[32px] border border-white/10 bg-[#171117] shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-5">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className={`inline-flex h-11 items-center justify-center rounded-full px-5 text-sm font-medium transition ${tone === 'danger' ? 'bg-red-500/90 text-white hover:bg-red-400' : 'bg-emerald-500 text-zinc-950 hover:bg-emerald-400'}`}
          >
            {confirmLabel}
          </button>
        </div>
